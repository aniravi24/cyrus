 ...
 */
import type { GitHubPlatformRef, GitLabPlatformRef, LinearPlatformRef, SlackPlatformRef } from "./platform-refs.js";
/**
 * Message action discriminator.
 * This is the primary discriminator for the internal message union type.
 */
export type MessageAction = "session_start" | "user_prompt" | "stop_signal" | "content_update" | "unassign" | "issue_state_change";
/**
...
export interface SessionStartMessage extends InternalMessageBase {
    ...
    platformData: LinearSessionStartPlatformData | GitHubSessionStartPlatformData | GitLabSessionStartPlatformData | SlackSessionStartPlatformData;
}
/**
...
export interface UserPromptMessage extends InternalMessageBase {
    ...
    platformData: LinearUserPromptPlatformData | GitHubUserPromptPlatformData | GitLabUserPromptPlatformData | SlackUserPromptPlatformData;
}
/**
 ...
 */
export type InternalMessage = SessionStartMessage | UserPromptMessage | StopSignalMessage | ContentUpdateMessage | UnassignMessage | IssueStateChangeMessage;
