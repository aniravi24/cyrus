 ...
 */
export type Issue = Pick<LinearSDK.Issue, "id" | "identifier" | "title" | "description" | "url" | "branchName" | "assigneeId" | "stateId" | "teamId" | "labelIds" | "priority" | "createdAt" | "updatedAt" | "archivedAt" | "state" | "assignee" | "team" | "parent" | "project"> & {
    labels(variables?: Omit<LinearSDK.LinearDocument.Issue_LabelsQueryVariables, "id">): Promise<Connection<Label>>;
    comments(variables?: Omit<LinearSDK.LinearDocument.Issue_CommentsQueryVariables, "id">): Promise<Connection<Comment>>;
    attachments(variables?: Omit<LinearSDK.LinearDocument.Issue_AttachmentsQueryVariables, "id">): Promise<Connection<LinearSDK.Attachment>>;
    children(variables?: Omit<LinearSDK.LinearDocument.Issue_ChildrenQueryVariables, "id">): Promise<Connection<Issue>>;
    inverseRelations(variables?: Omit<LinearSDK.LinearDocument.Issue_InverseRelationsQueryVariables, "id">): Promise<Connection<IssueRelation>>;
    update(input?: LinearSDK.LinearDocument.IssueUpdateInput): Promise<IssuePayload>;
};
/**
 ...
 */
export type Comment = Pick<LinearSDK.Comment, "id" | "body" | "createdAt" | "updatedAt" | "user" | "parent" | "issue"> & {
    children(variables?: LinearSDK.LinearDocument.Comment_ChildrenQueryVariables): Promise<Connection<Comment>>;
};
/**
 ...
 */
export type Label = Pick<LinearSDK.IssueLabel, "id" | "name" | "description" | "color">;
/**
 ...
 */
export type IssueRelation = Pick<LinearSDK.IssueRelation, "id" | "type" | "createdAt" | "updatedAt" | "archivedAt"> & {
 ...
 */
export type Team = Pick<LinearSDK.Team, "id" | "name" | "key" | "description" | "color" | "displayName"> & {
    states(variables?: Omit<LinearSDK.LinearDocument.Team_StatesQueryVariables, "id">): Promise<Connection<WorkflowState>>;
    members(variables?: Omit<LinearSDK.LinearDocument.Team_MembersQueryVariables, "id">): Promise<Connection<User>>;
};
/**
 ...
 */
export type User = Pick<LinearSDK.User, "id" | "name" | "displayName" | "email" | "gitHubUserId" | "url">;
/**
 ...
 */
export type WorkflowState = Pick<LinearSDK.WorkflowState, "id" | "name" | "type" | "description" | "color" | "position">;
/**
 ...
 */
export type IssuePayload = Pick<LinearSDK.IssuePayload, "success" | "issue" | "lastSyncId">;
/**
 ...
 */
export type AgentSessionSDKType = Pick<LinearSDK.AgentSession, "id" | "externalLink" | "summary" | "status" | "type" | "createdAt" | "updatedAt" | "archivedAt" | "startedAt" | "endedAt" | "appUserId" | "creatorId" | "issueId" | "commentId"> & {
    readonly appUser: Promise<User> | undefined;
    readonly creator: Promise<User> | undefined;
    readonly issue: Promise<Issue> | undefined;
    readonly comment: Promise<Comment> | undefined;
    activities(variables?: Omit<LinearSDK.LinearDocument.AgentSession_ActivitiesQueryVariables, "id">): Promise<Connection<LinearSDK.AgentActivity>>;
};
/**
 ...
 */
export type AgentSessionPayload = Pick<LinearSDK.AgentSessionPayload, "success" | "lastSyncId"> & {
 ...
 */
export type IssueTrackerAgentSession = Pick<LinearSDK.AgentSession, "id" | "externalLink" | "summary" | "status" | "type" | "createdAt" | "updatedAt" | "archivedAt" | "startedAt" | "endedAt" | "appUserId" | "creatorId" | "issueId" | "commentId"> & {
    readonly appUser: Promise<User> | undefined;
    readonly creator: Promise<User> | undefined;
    readonly issue: Promise<Issue> | undefined;
    readonly comment: Promise<Comment> | undefined;
 ...
 */
export type IssueTrackerAgentSessionPayload = Pick<LinearSDK.AgentSessionPayload, "success" | "lastSyncId"> & {
 ...
 */
export type IssueUpdateWebhook = LinearSDK.LinearDocument.EntityWebhookPayload & {
    type: "Issue";
    action: "update";
 ...
 */
export type IssueStateChangeWebhook = LinearSDK.LinearDocument.AppUserNotificationWebhookPayload;
/**
 * Platform-agnostic union of all webhook types.
 * Maps to Linear SDK's webhook payload union types.
 */
export type Webhook = LinearSDK.LinearDocument.AgentSessionEventWebhookPayload | LinearSDK.LinearDocument.AppUserNotificationWebhookPayload | LinearSDK.LinearDocument.EntityWebhookPayload;
/**
 ...
 */
export declare function isIssueStateChangeWebhook(webhook: Webhook): webhook is IssueStateChangeWebhook;
/**
 ...
 */
export type IssueDeletedWebhook = LinearSDK.LinearDocument.EntityWebhookPayload & {
    type: "Issue";
    action: "remove";
    data: LinearSDK.LinearDocument.IssueWebhookPayload;
};
 ...
 */
export declare function isIssueDeletedWebhook(webhook: Webhook): webhook is IssueDeletedWebhook;
/**
