...
function resolveGeminiSettingsPaths(projectRoot) {
 ...
 */
export function backupGeminiSettings(projectRoot) {
 ...
 */
export function restoreGeminiSettings(projectRoot) {
    const { settingsPath, backupPath } = resolveGeminiSettingsPaths(projectRoot);
 ...
 */
export function deleteGeminiSettings(projectRoot) {
 ...
 */
export function writeGeminiSettings(options, projectRoot) {
 ...
 * @param options - Settings options including maxSessionTurns, mcpServers, etc.
 */
export function setupGeminiSettings(options, projectRoot) {
