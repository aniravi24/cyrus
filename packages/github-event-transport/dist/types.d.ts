...
export interface GitHubWebhookEvent {
    ...
    payload: GitHubIssueCommentPayload | GitHubPullRequestReviewCommentPayload | GitHubPullRequestReviewPayload | GitHubPullRequestPayload | GitHubPushPayload;
 ...
 */
export type GitHubEventType = "issue_comment" | "pull_request_review_comment" | "pull_request_review" | "pull_request" | "push";
/**
 * Comment-related GitHub event types (excludes push and pull_request, neither of
 * which carries a comment body).
 */
export type GitHubCommentEventType = Exclude<GitHubEventType, "push" | "pull_request">;
/**
...
export interface GitHubCommentWebhookEvent {
    ...
    deliveryId: string;
    payload: GitHubIssueCommentPayload | GitHubPullRequestReviewCommentPayload | GitHubPullRequestReviewPayload;
    installationToken?: string;
}
/**
