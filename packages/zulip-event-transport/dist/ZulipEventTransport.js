...
export class ZulipEventTransport extends EventEmitter {
     ...
     */
    register() {
        this.config.fastifyServer.post("/zulip-webhook", async (request, reply) => {
            try {
    ...
    handleWebhook(request, reply) {
        ...
        this.logger.info(`Received ${trigger} webhook (message: ${payload.message.id}, topic: ${payload.message.subject})`);
...
//# sourceMappingURL=ZulipEventTransport.js.map