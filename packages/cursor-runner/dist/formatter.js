...
export class CursorMessageFormatter {
    formatTodoWriteParameter(jsonContent) {
        try {
            ...
            const lines = parsed.todos.map((todo) => {
                ...
                const content = typeof todo.content === "string"
                    ...
                    : typeof todo.description === "string"
                        ? todo.description
                        : "";
                const isCompleted = status === "completed" || status === "todo_status_completed";
                const isInProgress = status === "in_progress" || status === "todo_status_in_progress";
