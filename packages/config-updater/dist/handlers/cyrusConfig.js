...
import { getDefaultWorktreesDir } from "cyrus-core";
    ...
    try {
        ...
        const repositories = edgeConfig.repositories.map((repo) => {
            return {
                ...
                workspaceBaseDir: repo.workspaceBaseDir || getDefaultWorktreesDir(cyrusHome),
        ...
        const normalizedEdgeConfig = {
            ...edgeConfig,
            claudeDefaultModel: edgeConfig.claudeDefaultModel || edgeConfig.defaultModel,
            claudeDefaultFallbackModel: edgeConfig.claudeDefaultFallbackModel ||
