 ...
 */
const defaultLogger = {
    info: (message, ...args) => console.log(`[WorktreeIncludeService] ${message}`, ...args),
    warn: (message, ...args) => console.warn(`[WorktreeIncludeService] ${message}`, ...args),
    error: (message, ...args) => console.error(`[WorktreeIncludeService] ${message}`, ...args),
};
/**
