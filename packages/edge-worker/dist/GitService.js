 ...
 */
const defaultLogger = {
    info: (message, ...args) => console.log(`[GitService] ${message}`, ...args),
    warn: (message, ...args) => console.warn(`[GitService] ${message}`, ...args),
    error: (message, ...args) => console.error(`[GitService] ${message}`, ...args),
};
/**
