...
export class AttachmentService {
    ...
    cyrusHome;
    linearWorkspaces;
    constructor(logger, cyrusHome, linearWorkspaces) {
        this.logger = logger;
     ...
     */
    setLinearWorkspaces(linearWorkspaces) {
        this.linearWorkspaces = linearWorkspaces;
    }
    /**
     ...
     */
    async downloadIssueAttachments(issue, linearWorkspaceId, workspacePath, issueTracker) {
