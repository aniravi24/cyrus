 ...
 */
export declare const GITHUB_MAINTENANCE_MARKER = "<!-- cyrus:maintenance -->";
export declare function extractReviewRequestSha(body: string): string | null;
/**
 * Posted when maintenance mode is on and no `message` is configured.
 */
export declare const DEFAULT_MAINTENANCE_MESSAGE = "Cyrus is temporarily off for maintenance, so nothing was started for this request. Mention me again once it is back on.";
/**
 ...
 */
export declare function extractLeadingRunnerSelectors(commentBody: string, botUsername: string | undefined): string | undefined;
...
export declare class EdgeWorker extends EventEmitter {
    ...
    private zulipEventTransport;
    private zulipChatSessionHandler;
     ...
     */
    private get activeChatSessionHandlers();
    /**
     ...
     * request.
     */
    private registerZulipEventTransport;
    /**
     ...
     */
    private handleGitHubPullRequestClosed;
    /**
