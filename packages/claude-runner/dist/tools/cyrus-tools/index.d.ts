 ...
 */
export declare function createCyrusToolsServer(linearApiToken: string, options?: CyrusToolsOptions): import("@anthropic-ai/claude-agent-sdk").McpSdkServerConfigWithInstance;
